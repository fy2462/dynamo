...
impl RuntimeMetrics {
    ...
    fn create_counter(
        ...
        let counter = rs::metrics::create_metric(
    ...
    fn create_countervec(
        ...
        let counter_vec = rs::metrics::create_metric(
            self.hierarchy.as_ref(),
            &name,
            &description,
            &const_labels_vec,
    ...
    fn create_gauge(
        ...
        let gauge = rs::metrics::create_metric(
            self.hierarchy.as_ref(),
            &name,
            &description,
            &labels_vec,
    ...
    fn create_gaugevec(
        ...
        let label_names_str = Self::convert_py_to_rust_label_names(&label_names);
        let const_labels_vec = Self::convert_py_to_rust_labels(&const_labels);
        let gauge_vec = rs::metrics::create_metric(
            self.hierarchy.as_ref(),
            &name,
            &description,
            &const_labels_vec,
    ...
    fn create_histogram(
        ...
        let histogram = rs::metrics::create_metric(
            self.hierarchy.as_ref(),
            &name,
            &description,
            &labels_vec,
